...
public class ImportController {
    ...
    public static List<IndexSymNode> indexSym=new ArrayList<>();
    //每个用户都有一个tableName
...
/*                        // 获取element类型的节点和节点值
    ...
    public void keepData(List<String[]> list){
        ...
        if(fileType.equals("indexSym")) {
            ...
            for (String[] l : list) {
                indexSymService.insertIntoTable(indexSymTableName, l[0], Integer.parseInt(l[1]), Double.parseDouble(l[2]), Integer.parseInt(l[3]));
            }
